...
const CASE_STUDIES: CaseStudyEntry[] = [
  {
    id: '1',
    title: 'Designing for Emotion: How Luminary Changed Engagement',
    description:
      'A deep-dive into building a mood-adaptive interface — from user research to ML model integration, and how emotional UX transformed retention by 340%.',
    tag: 'UX Design',
    slug: 'luminary',
    linkedinUrl: null,
    accent: '#E8593C',
  ...
  {
    id: '2',
    title: 'Data as Art: The Cartograph Visual System',
    description:
      'When your data is beautiful, people actually want to engage with it. How we turned raw CSV files into cinematic 3D narratives.',
    tag: 'Visual Design',
    slug: 'cartograph',
    linkedinUrl: null,
    accent: '#3B8BD4',
    index: 1,
    imageLabel: 'Cartograph',
  },
  {
    id: '3',
    title: 'Breaking Into Product: My Unconventional Path',
    description:
      'From engineering student to product builder — the mindset shifts, the mistakes, and the frameworks that actually stuck.',
    tag: 'LinkedIn',
    slug: null,
    linkedinUrl: 'https://linkedin.com/in/basanthyajman',
    accent: '#1D9E75',
    index: 2,
    imageLabel: 'Post',
  },
  {
    id: '4',
    title: 'Why Most Portfolios Fail (And How To Fix Yours)',
    description:
      'A critical analysis of 50 developer portfolios and the 7 patterns that separate the memorable from the forgettable.',
    tag: 'LinkedIn',
    slug: null,
    linkedinUrl: 'https://linkedin.com/in/basanthyajman',
    accent: '#BA7517',
