...
const CASE_STUDIES: CaseStudyEntry[] = [
  {
    id: '1',
    title: 'Australian GP 2026: V1 Prediction — Russell 38.9%',
    description:
    ...
    slug: 'f1-aus-gp',
    linkedinUrl: null,
    pdfUrl: '/docs/F1_2026_AusGP_Prediction_Report.pdf',
    accent: '#C1121F',
    index: 0,
    imageLabel: 'V1 · AUS',
  },
  {
    id: '2',
    title: 'Japanese GP 2026: Antonelli on Pole at Suzuka',
    description:
  ...
  {
    id: '3',
    title: 'Chinese GP 2026: V2 — Sprint as Tier 0 Data',
    description:
    ...
    slug: 'f1-china-gp',
    linkedinUrl: null,
    pdfUrl: '/docs/2026_Chinese_GP_Prediction_Report.pdf',
    accent: '#FF4655',
    index: 2,
    imageLabel: 'V2 · CHN',
  },
